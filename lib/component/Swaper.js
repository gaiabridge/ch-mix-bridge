...
class Swaper extends skynode_1.DomNode {
  constructor() {
    ...
    this.append(
      (0, skynode_1.el)(
        ".form-container",
        (this.fromForm = new Form_1.default(this, 8217, true)),
        (0, skynode_1.el)("img.arrow", {
          src: "/images/arrow.png",
          height: "50",
        }),
        (0, skynode_1.el)("img.mobile-arrow", {
          src: "/images/arrow.png",
          height: "50",
        }),
        (this.toForm = new Form_1.default(this, 137))
      ),
      (0, skynode_1.el)(
        ".history",
        (0, skynode_1.el)("h2", "전송 기록"),
        (this.sendedList = (0, skynode_1.el)(".sended-list"))
      )
    );
  ...
  async loadHistory() {
    if (
      ...
      if (sender !== undefined && receiver !== undefined) {
        ...
        skyutil_1.default.repeatResultAsync(
          count.toNumber(),
          async (sendId) => {
            if (this.loadHistoryNonce === nonce) {
              this.addSended(
                sender,
                receiver,
                bignumber_1.BigNumber.from(sendId)
              );
            }
          }
        );
