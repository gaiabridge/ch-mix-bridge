            ...
            if (sender !== undefined && receiver !== undefined) {
                ...
                skyutil_1.default.repeatResultAsync(count.toNumber(), async (sendId) => {
                    if (this.loadHistoryNonce === nonce && this.fromForm.sender !== undefined && this.toForm.sender !== undefined) {
                        this.sendedList.append(new Sended_1.default(this.fromForm.sender, this.toForm.sender, this.fromForm.chainId, this.toForm.chainId, sender, receiver, sendId, async () => {
